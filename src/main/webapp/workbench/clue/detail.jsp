        ...
        $(function () {
            ...
            $("#addActivity").click(function () {
                ...
                if ($("input[name=xz]:checked").length == 0) {
                    ...
                    var id = ""
                    for (var i = 0; i < $("input[name=xz]:checked").length; i++) {
                        id += $("input[name=xz]:checked")[i].value
                        if (i != $("input[name=xz]:checked").length - 1) {
                            id += ","
                        }
                    }
                    console.log(id)
                    $.ajax({
                        url: "/clue/addActivity",
                        data: {
                            "activityId": id,
                            "clueId": "${c.id}"
                        },
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="btn-group" style="position: relative; top: 18%; left: 8px;">
                    <form class="form-inline" role="form" id="activityAddForm">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="addActivity">关联</button>
            </div>
        </div>
    </div>
</div>
...
<div style="position: relative; left: 40px; top: -30px;">
    ...
    <div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
        <button type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/convert.jsp?fullname=${c.fullname}&appellation=${c.appellation}&company=${c.company}&owner=${c.owner}&id=${c.id}';"><span
